...
@section('contentsearch')
       <form class="form-horizontal searchForm" method="post" role="form" action="{{ url('reports/candidatehistory') }}">
			@csrf
...
@include('partials.flashmessages')
		...
		<div class="card card-header candidate" >
			<div class="row">
				<div class="col-md-4">
					<h3>{{ __('Candidate History Report') }}</h3>
				</div>
			</div>
		</div>

@include('reports.candidatehistoryresults')
