...
@php $default__prop = (isset($fielddefault)) ? $fielddefault : null @endphp
                        ...
                        <div class="form-label-group in-border row">
								...
								{!! Form::number($fieldname, $default__prop, array('id'=>$fieldname, 'min'=>$fieldmin, 'placeholder' => $fieldlabel,'class' => 'form-control', $required__prop, $autofocus__prop, 'autocomplete')) !!}
