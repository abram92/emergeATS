...
@include('partials.form_text', ['fieldname'=>'description', 
                        ...
                        <div class="row">
						    <div id="colour_highlight" class="col-xs-12 col-sm-12 col-md-12">
								<span class="float-left">
								<input class="form-control-check col-sm-2" placeholder="" name="colour_no" type="checkbox" id="colour_no" {{ old('colour_hex', isset($team) ? $team->colour_hex : "" ) ? '' : 'checked' }}>
								<label for="colour_no" class="form-check-label">{{ __('No Highlight') }}</label>
								</span>
								<span class="float-left">
								<input class="form-control-color col-sm-2" title="Choose colour" placeholder="" name="colour_hex" default="#ffffff" type="{{ old('colour_hex', isset($team) ? $team->colour_hex : "" ) ? 'color' : 'hidden' }}" id="colour_hex" value="{{ old('colour_hex', isset($team) ? $team->colour_hex : "" ) }}">
								</span>
							</div>	
                            <label for="colour_highlight" class="col-form-label">{{ __('Highlight') }}</label>							
                        </div>						
