                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Base Data <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('admin.clientstatus.index')}}"> Client Status </a></li>
                                        <li><a href="{{route('admin.candidatestatus.index')}}"> Candidate status </a></li>
                                        <li><a href="{{route('admin.jobtitles.index')}}"> Job title </a></li>
                                    </ul>
                                </li>
                                <li><a href="{{route('candidates.index')}}"><i class="fa fa-user"></i> Candidates </a></li>
                                <li><a href="{{route('clients.index')}}"><i class="fa fa-shopping-cart"></i> Clients </a></li>
								<li><a href="{{route('jobs.index')}}"><i class="fa fa-shopping-cart"></i> Jobs </a></li>
